...
RSpec.feature 'Administer admin users', type: :feature do
  ...
  context 'when logged in' do
    ...
    context 'when showing index' do
      ...
      [ :name, :email, :current_sign_in_at, :sign_in_count, :created_at, :updated_at ].each do |field|
    ...
    context 'when viewing record' do
      ...
      [ :name, :email, :unconfirmed_email, :confirmation_sent_at, :confirmed_at, :reset_password_sent_at,
