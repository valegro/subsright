...
RSpec.describe Publication, type: :model do
  ...
  it 'ensures api_key is unique' do
    existing_publication = create :publication
    publication.update! api_key: existing_publication.api_key
    expect(publication.api_key).not_to eq existing_publication.api_key
  end
end
