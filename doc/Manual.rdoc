...
You can choose which currencies you are able to accept payments in, and set the display format
for each.
...
number of issues or period of time together with some number of products (or none).  Offers need
not have any publications or products if you wish to use them to ask for donations.  They can
optionally have an expiry date after which the offer will no longer be shown.
...
specified number of issues or period of time.  Customers will be contacted to encourage them to
take up a new offer to renew their subscription when their expiry date is imminent.
