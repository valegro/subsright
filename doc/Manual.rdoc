...
Customers who have made transactions cannot be deleted until the transactions have been archived.
It should be possible to migrate all publications and transactions of a customer to another
customer, which will permit the first customer to be deleted.  This is not yet implemented.
...
Offers that have associated transactions cannot be deleted until all associated transactions
have been archived.
...
Products cannot be deleted while they are part of any offer or offers.
